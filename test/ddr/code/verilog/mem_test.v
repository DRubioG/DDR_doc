...
(
	...
	//output reg  [63:0]               error_cnt,                               // test data error
...
reg[15:0]     wr_data_pre_add;
reg[15:0]     rd_data_pre_add;
...
assign  expect_read_data         = {(MEM_DATA_BITS/16){wr_data_pre_add}};;// next_wr_burst_data = rd_burst_addr + rd_cnt
...
ila_0 your_instance_name (
	...
	.probe0(rd_burst_req), // input wire [0:0]  probe0  
	.probe1(wr_burst_req), // input wire [0:0]  probe1 
	.probe2(rd_burst_len), // input wire [9:0]  probe2 
	.probe3(wr_burst_len), // input wire [9:0]  probe3 
	.probe4(rd_burst_addr), // input wire [23:0]  probe4 
	.probe5(wr_burst_addr), // input wire [23:0]  probe5 
	.probe6(rd_burst_data_valid), // input wire [0:0]  probe6 
	.probe7(wr_burst_data_req), // input wire [0:0]  probe7 
	.probe8(rd_burst_data), // input wire [63:0]  probe8 
